...
<div class="content">
	...
	<p>
		...
		erfolgt dies stets auf freiwilliger Basis. Diese Daten werden ohne Ihre ausdrückliche Zustimmung
		nicht an Dritte weitergegeben. Wir weisen darauf hin, dass die Datenübertragung im Internet
		(z.B. bei der Kommunikation per E-Mail) Sicherheitslücken aufweisen kann. Ein lückenloser Schutz
	...
	<p>
		...
		Versand der angeforderten Informationen und geben sie nicht an Dritte weiter. Die erteilte
